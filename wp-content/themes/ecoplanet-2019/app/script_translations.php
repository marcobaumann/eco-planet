...
function translate_scripts(){
	...
	wp_localize_script( 'main', 'wp_translations', array(
		//'no_documents'  		=> __('Não há nenhum documento no período ou no idioma selecionado.', 'ecoplanet_2019'),
		//'no_data'  				=> __('Não há nenhum dado no período selecionado.', 'ecoplanet_2019'),
	) );
